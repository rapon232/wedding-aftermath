    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:${card};border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(37,26,22,.12)">
        ...
        <tr><td align="center" style="padding:20px 32px 8px">
          ...
          <p style="margin:12px 0 0;font-size:13px;color:${muted};font-family:${sans}">That button logs you straight in &mdash; no need to type the code.</p>
        </td></tr>
        <tr><td align="center" style="padding:24px 32px 32px">
          <p style="margin:0;font-family:${serif};font-style:italic;font-size:20px;color:${dark}">&#128131;&#10024; With Love, Jenny and Mitko &#127796;&#10084;&#65039;</p>
        </td></tr>
      </table>
    </td></tr>
  </table></body></html>`;
